...
CONFIG = {'title': 'Water Chemistry and Environmental Monitoring', 'model_type': 'water', 'group_key': 'medium', 'description': 'Advanced water chemistry workflows for benchmark screening, nutrient loads, oxygen deficit, pH interpretation, hydrologic context, QA scoring, and monitoring evidence.', 'rows': [{'sample_id': 'WAT001', 'medium': 'river', 'analyte': 'nitrate_as_N', 'concentration': 7.8, 'benchmark': 10.0, 'unit': 'mg/L', 'flow_L_s': 820, 'pH': 7.4, 'do_sat_mg_L': 10.2, 'do_obs_mg_L': 8.2, 'qc_score': 0.93}, {'sample_id': 'WAT002', 'medium': 'river', 'analyte': 'phosphate_as_P', 'concentration': 0.18, 'benchmark': 0.1, 'unit': 'mg/L', 'flow_L_s': 820, 'pH': 7.4, 'do_sat_mg_L': 10.2, 'do_obs_mg_L': 8.2, 'qc_score': 0.9}, {'sample_id': 'WAT003', 'medium': 'lake', 'analyte': 'dissolved_oxygen', 'concentration': 4.6, 'benchmark': 5.0, 'unit': 'mg/L', 'flow_L_s': 0, 'pH': 8.3, 'do_sat_mg_L': 8.5, 'do_obs_mg_L': 4.6, 'qc_score': 0.88}, {'sample_id': 'WAT004', 'medium': 'groundwater', 'analyte': 'arsenic', 'concentration': 12.0, 'benchmark': 10.0, 'unit': 'ug/L', 'flow_L_s': 5, 'pH': 7.1, 'do_sat_mg_L': 9.8, 'do_obs_mg_L': 1.1, 'qc_score': 0.86}, {'sample_id': 'WAT005', 'medium': 'stormwater', 'analyte': 'lead', 'concentration': 18.0, 'benchmark': 15.0, 'unit': 'ug/L', 'flow_L_s': 210, 'pH': 7.0, 'do_sat_mg_L': 9.1, 'do_obs_mg_L': 6.4, 'qc_score': 0.8}], 'future': ['storm-event load estimation', 'censored-data statistics', 'sensor drift correction', 'watershed spatial joins', 'Bayesian trend models'], 'slug': 'water-chemistry-environmental-monitoring'}
...
def write_report(indicators, summary_rows):
    ...
    report = [
        f"# Advanced Computational Report: Water Chemistry and Environmental Monitoring",
        "",
        CONFIG["description"],
        "",
