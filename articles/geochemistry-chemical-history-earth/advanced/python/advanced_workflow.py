...
CONFIG = {'title': 'Geochemistry and the Chemical History of Earth', 'model_type': 'geochemistry', 'group_key': 'rock_type', 'description': 'Advanced geochemistry workflows for major-oxide indices, isotope notation, radiometric dating, trace-element ratios, redox archives, weathering screens, and deep-time chemical evidence.', 'rows': [{'sample_id': 'GEO001', 'rock_type': 'basalt', 'SiO2': 49.2, 'Al2O3': 15.4, 'FeO': 10.8, 'CaO': 10.5, 'Na2O': 2.9, 'K2O': 0.8, 'Rb_ppm': 12, 'Sr_ppm': 420, 'U_ppm': 0.3, 'Th_ppm': 0.9, 'parent': 1.0, 'daughter': 0.18, 'sample_ratio': 0.01112, 'standard_ratio': 0.01118}, {'sample_id': 'GEO002', 'rock_type': 'granite', 'SiO2': 72.5, 'Al2O3': 14.1, 'FeO': 2.2, 'CaO': 1.8, 'Na2O': 3.6, 'K2O': 4.8, 'Rb_ppm': 165, 'Sr_ppm': 190, 'U_ppm': 4.2, 'Th_ppm': 18.0, 'parent': 1.0, 'daughter': 0.35, 'sample_ratio': 0.0112, 'standard_ratio': 0.01118}, {'sample_id': 'GEO003', 'rock_type': 'shale', 'SiO2': 61.0, 'Al2O3': 18.2, 'FeO': 6.5, 'CaO': 1.2, 'Na2O': 1.1, 'K2O': 3.4, 'Rb_ppm': 110, 'Sr_ppm': 160, 'U_ppm': 3.1, 'Th_ppm': 12.5, 'parent': 1.0, 'daughter': 0.28, 'sample_ratio': 0.01093, 'standard_ratio': 0.01118}, {'sample_id': 'GEO004', 'rock_type': 'weathered_saprolite', 'SiO2': 54.0, 'Al2O3': 25.5, 'FeO': 8.9, 'CaO': 0.8, 'Na2O': 0.3, 'K2O': 1.2, 'Rb_ppm': 45, 'Sr_ppm': 85, 'U_ppm': 2.0, 'Th_ppm': 8.5, 'parent': 1.0, 'daughter': 0.12, 'sample_ratio': 0.01098, 'standard_ratio': 0.01118}, {'sample_id': 'GEO005', 'rock_type': 'banded_iron_formation', 'SiO2': 46.0, 'Al2O3': 2.5, 'FeO': 38.0, 'CaO': 2.0, 'Na2O': 0.2, 'K2O': 0.4, 'Rb_ppm': 8, 'Sr_ppm': 45, 'U_ppm': 1.2, 'Th_ppm': 2.7, 'parent': 1.0, 'daughter': 0.5, 'sample_ratio': 0.01105, 'standard_ratio': 0.01118}], 'future': ['molar CIA with CaO correction', 'isotope mixing models', 'concordia/discordia scaffolding', 'rare-earth normalization', 'multi-proxy redox inference'], 'slug': 'geochemistry-chemical-history-earth'}
...
def write_report(indicators, summary_rows):
    ...
    report = [
        f"# Advanced Computational Report: Geochemistry and the Chemical History of Earth",
        "",
        CONFIG["description"],
        "",
