...
CONFIG = {'title': 'Atmospheric Chemistry and Climate Processes', 'model_type': 'atmospheric', 'group_key': 'chemical_class', 'description': 'Advanced atmospheric chemistry workflows for greenhouse forcing, ozone formation proxies, aerosol screening, atmospheric lifetime, oxidizing capacity, and climate-chemistry indicators.', 'rows': [{'sample_id': 'ATM001', 'chemical_class': 'greenhouse_gas', 'species': 'CO2', 'concentration': 423.0, 'reference': 280.0, 'unit': 'ppm', 'lifetime_days': 36500, 'nox_ppb': 0, 'voc_ppb': 0, 'sunlight_index': 1.0, 'aod': 0.06, 'single_scattering_albedo': 0.96}, {'sample_id': 'ATM002', 'chemical_class': 'greenhouse_gas', 'species': 'CH4', 'concentration': 1950.0, 'reference': 722.0, 'unit': 'ppb', 'lifetime_days': 4380, 'nox_ppb': 0, 'voc_ppb': 0, 'sunlight_index': 1.0, 'aod': 0.03, 'single_scattering_albedo': 0.94}, {'sample_id': 'ATM003', 'chemical_class': 'secondary_pollutant', 'species': 'O3', 'concentration': 0.078, 'reference': 0.07, 'unit': 'ppm', 'lifetime_days': 0.2, 'nox_ppb': 38, 'voc_ppb': 85, 'sunlight_index': 1.15, 'aod': 0.08, 'single_scattering_albedo': 0.93}, {'sample_id': 'ATM004', 'chemical_class': 'aerosol', 'species': 'PM2.5', 'concentration': 18.5, 'reference': 15.0, 'unit': 'ug/m3', 'lifetime_days': 4, 'nox_ppb': 22, 'voc_ppb': 40, 'sunlight_index': 0.85, 'aod': 0.22, 'single_scattering_albedo': 0.88}, {'sample_id': 'ATM005', 'chemical_class': 'reactive_carbon', 'species': 'CO', 'concentration': 0.9, 'reference': 0.4, 'unit': 'ppm', 'lifetime_days': 60, 'nox_ppb': 16, 'voc_ppb': 35, 'sunlight_index': 0.95, 'aod': 0.05, 'single_scattering_albedo': 0.95}], 'future': ['photochemical box modeling', 'OH lifetime coupling', 'aerosol-cloud interaction modules', 'emissions inventory joins', 'chemical transport model scaffolding'], 'slug': 'atmospheric-chemistry-climate-processes'}
...
def write_report(indicators, summary_rows):
    ...
    report = [
        f"# Advanced Computational Report: Atmospheric Chemistry and Climate Processes",
        "",
        CONFIG["description"],
        "",
