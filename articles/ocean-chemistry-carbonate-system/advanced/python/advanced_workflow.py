...
CONFIG = {'title': 'Ocean Chemistry and the Carbonate System', 'model_type': 'ocean', 'group_key': 'water_type', 'description': 'Advanced ocean chemistry workflows for carbonate speciation, alkalinity-DIC relationships, aragonite saturation, air-sea CO2 flux proxy, Revelle intuition, and ocean-carbon monitoring evidence.', 'rows': [{'sample_id': 'OC001', 'water_type': 'open_ocean', 'station': 'Open-Ocean-A', 'pH': 8.1, 'DIC_umol_kg': 2050, 'TA_umol_kg': 2310, 'pCO2_uatm': 410, 'pCO2_air_uatm': 420, 'calcium_mmol_kg': 10.3, 'temperature_C': 22.0, 'salinity': 35.0, 'wind_speed_m_s': 6.0}, {'sample_id': 'OC002', 'water_type': 'upwelling', 'station': 'Upwelling-B', 'pH': 7.78, 'DIC_umol_kg': 2240, 'TA_umol_kg': 2285, 'pCO2_uatm': 820, 'pCO2_air_uatm': 420, 'calcium_mmol_kg': 10.1, 'temperature_C': 10.5, 'salinity': 34.2, 'wind_speed_m_s': 8.5}, {'sample_id': 'OC003', 'water_type': 'reef', 'station': 'Reef-C', 'pH': 8.02, 'DIC_umol_kg': 1980, 'TA_umol_kg': 2290, 'pCO2_uatm': 455, 'pCO2_air_uatm': 420, 'calcium_mmol_kg': 10.5, 'temperature_C': 27.8, 'salinity': 36.1, 'wind_speed_m_s': 5.5}, {'sample_id': 'OC004', 'water_type': 'estuary', 'station': 'Estuary-D', 'pH': 7.62, 'DIC_umol_kg': 2300, 'TA_umol_kg': 2170, 'pCO2_uatm': 1150, 'pCO2_air_uatm': 420, 'calcium_mmol_kg': 8.4, 'temperature_C': 18.2, 'salinity': 28.5, 'wind_speed_m_s': 4.0}, {'sample_id': 'OC005', 'water_type': 'polar_shelf', 'station': 'Polar-E', 'pH': 7.88, 'DIC_umol_kg': 2180, 'TA_umol_kg': 2260, 'pCO2_uatm': 620, 'pCO2_air_uatm': 420, 'calcium_mmol_kg': 9.8, 'temperature_C': 1.5, 'salinity': 32.8, 'wind_speed_m_s': 9.0}], 'future': ['full carbonate-equilibrium solver', 'pH scale conversion', 'temperature-salinity-pressure constants', 'uncertainty propagation', 'OCADS-style metadata validation'], 'slug': 'ocean-chemistry-carbonate-system'}
...
def write_report(indicators, summary_rows):
    ...
    report = [
        f"# Advanced Computational Report: Ocean Chemistry and the Carbonate System",
        "",
        CONFIG["description"],
        "",
